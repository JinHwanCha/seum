...
ON CONFLICT (department_id, role_key) DO NOTHING;
...
INSERT INTO villages (id, group_year_id, name, sort_order, is_new_member_team) VALUES
  ...
  ('a0000001-0000-0000-0000-000000000009', '44444444-4444-4444-4444-444444444444', '새가족반', 9, true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 무명 마을 - 목원 박서연
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 무명 마을 - 목원 이하은
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
   '이하은', '010-1111-0003', '$2a$12$1WZzlZKExDlQmb/Wij4umecC8xTIFyw4LnxRfdp0xNpCtY9faIPk2',
   'cell_member', 'a0000001-0000-0000-0000-000000000001', 'c0000001-0000-0000-0000-000000000001', true)
ON CONFLICT (id) DO NOTHING;
-- 무명 마을 - 목자 장유진 (무명2셀)
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 무명 마을 - 목원 최준호 (무명2셀)
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 내일 마을 - 목원 오지훈
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000008', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 내일 마을 - 목자 윤서아 (내일2셀)
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000009', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 내일 마을 - 목원 송예진 (내일2셀)
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000010', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 닛시 마을 - 목자 강도현
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000011', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
-- 닛시 마을 - 목원 임소율
INSERT INTO users (id, church_id, department_id, name, phone, password_hash, role, village_id, cell_id, is_approved) VALUES
  ('a0000002-0000-0000-0000-000000000012', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
INSERT INTO prayer_requests (user_id, department_id, week_start, content) VALUES
  ...
  ('a0000002-0000-0000-0000-000000000006', '22222222-2222-2222-2222-222222222222',
   date_trunc('week', CURRENT_DATE + interval '1 day')::date - interval '1 day',
   '마을 전체가 하나 되어 섬길 수 있도록, 마을원들의 영적 성장을 위해 기도합니다.'),
  ('a0000002-0000-0000-0000-000000000007', '22222222-2222-2222-2222-222222222222',
   date_trunc('week', CURRENT_DATE + interval '1 day')::date - interval '1 day',
   '직장에서의 인간관계가 회복되도록 기도해주세요. 동료들에게 좋은 영향력을 끼치고 싶습니다.'),
  ('a0000002-0000-0000-0000-000000000008', '22222222-2222-2222-2222-222222222222',
   date_trunc('week', CURRENT_DATE + interval '1 day')::date - interval '1 day',
   '이번 주 말씀 묵상을 통해 하나님의 음성을 분명히 들을 수 있기를 기도합니다.'),
  ('a0000002-0000-0000-0000-000000000009', '22222222-2222-2222-2222-222222222222',
   date_trunc('week', CURRENT_DATE + interval '1 day')::date - interval '1 day',
   '셀 모임에 나오지 못하는 멤버들을 위해 기도합니다. 다시 교제의 자리로 돌아올 수 있기를 원합니다.'),
  ('a0000002-0000-0000-0000-000000000010', '22222222-2222-2222-2222-222222222222',
   date_trunc('week', CURRENT_DATE + interval '1 day')::date - interval '1 day',
   '신앙의 성장을 위해 기도합니다. 매일 큐티를 빠지지 않고 할 수 있도록 도와주세요.'),
  ('a0000002-0000-0000-0000-000000000011', '22222222-2222-2222-2222-222222222222',
   date_trunc('week', CURRENT_DATE + interval '1 day')::date - interval '1 day',
   '선교 여행 준비를 위해 기도해주세요. 팀원들과 하나 되어 준비할 수 있기를 바랍니다.'),
  ('a0000002-0000-0000-0000-000000000012', '22222222-2222-2222-2222-222222222222',
   date_trunc('week', CURRENT_DATE + interval '1 day')::date - interval '1 day',
