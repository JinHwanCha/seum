...
CREATE TABLE attendance (
  ...
  wednesday_worship TEXT CHECK (wednesday_worship IS NULL OR wednesday_worship IN ('현장', '온라인')),
  friday_worship TEXT CHECK (friday_worship IS NULL OR friday_worship IN ('현장', '온라인')),
  dawn_mon TEXT CHECK (dawn_mon IS NULL OR dawn_mon IN ('현장', '온라인')),
  dawn_tue TEXT CHECK (dawn_tue IS NULL OR dawn_tue IN ('현장', '온라인')),
  dawn_wed TEXT CHECK (dawn_wed IS NULL OR dawn_wed IN ('현장', '온라인')),
  dawn_thu TEXT CHECK (dawn_thu IS NULL OR dawn_thu IN ('현장', '온라인')),
  dawn_fri TEXT CHECK (dawn_fri IS NULL OR dawn_fri IN ('현장', '온라인')),
